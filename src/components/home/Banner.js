                      ...
                      <div className="flex lg:flex-row flex-col-reverse justify-between items-center lg:pt-12 lg:pb-16 md:py-12 sm:py-8 py-5 md:px-6 px-3 gap-5">
                        <div className="lg:w-[52%]">
                          <div className="flex items-center gap-1">
                            ...
                            <div className="text-primary-foreground font-semibold lg:text-base md:text-sm text-xs">
                              Moving Service, since 1945.
                            </div>
                          </div>
                          ...
                          <div className="text-para md:text-lg sm:text-base text-sm">
                            Transform your bathroom into a haven of elegance and
                            functionality with our diverse range of premium
                            bathroom fixtures, tailored to suit every style and
                            need.
                          </div>
                        ...
                        <Image
                          ...
                          width={550}
                          height={630}
                          className="lg:object-contain xl:w-[550px] lg:w-[420px]  w-full lg:h-auto h-[300px] object-cover rounded-xl"
                          src={data.img}
                        />
                      </div>
                    </div>
